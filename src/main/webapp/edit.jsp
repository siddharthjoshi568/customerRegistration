...
<body>
	...
	<div class="container">
		<form action="UpdateServlet" method="POST">
			<h2 class="text-center">Edit here!</h2>
			<%@include file="components/message.jsp"%>
			<div class="row jumbotron">
			<input type="hidden" value="<%=ub.getPartyId() %>" name="partyId"/>

				<div class="col-sm-6 form-group">
					<label for="name-f">First Name</label> <input type="text"
						class="form-control" name="firstName" id="firstName"
						placeholder="<%=ub.getFirstName() %>" value="<%=ub.getFirstName() %>">
				</div>
				<div class="col-sm-6 form-group">
					<label for="name-l">Last name</label> <input type="text"
						class="form-control" name="lastName" id="lastName"
						placeholder="<%=ub.getLastName() %>" value="<%=ub.getLastName() %>">
				</div>
				<div class="col-sm-6 form-group">
					<label for="address">Address</label> <input type="address"
						class="form-control" name="address" id="address"
						placeholder="<%=ub.getAddress() %>" value="<%=ub.getAddress() %>">
				</div>
				<div class="col-sm-6 form-group">
					<label for="city">City</label> <input type="text"
						class="form-control" name="city" id="city"
						placeholder="<%=ub.getCity() %>" value="<%=ub.getCity() %>">
				</div>
				<div class="col-sm-4 form-group">
					<label for="State">State</label> <input type="address"
						class="form-control" name="state" id="state"
						placeholder="<%=ub.getState() %>" value="<%=ub.getState() %>">
				</div>
				<div class="col-sm-2 form-group">
					<label for="zip">Postal-Code</label> <input type="zip"
						class="form-control" name="zip" id="zip"
						placeholder="<%=ub.getZip() %>" value="<%=ub.getZip() %>">
				</div>
				<div class="col-sm-6 form-group">
					<label for="Country">Country</label> <select
						class="form-control custom-select browser-default"  value="<%=ub.getCountry() %>">
						<option value="<%=ub.getCountry() %>"><%=ub.getCountry() %></option>
				...
				<div class="col-sm-6 form-group">
					<label for="tel">Phone</label> <input type="tel" name="phone"
						...
						placeholder="<%=ub.getPhone() %>" value="<%=ub.getPhone() %>">
				</div>
				<!-- <div class="col-sm-6 form-group">
					<label for="userLoginId">UserLogin Id</label> <input type="text"
						class="form-control" name="userLoginId" id="userLoginId"
						placeholder="Enter your User Login Id." required>
				</div>
				<div class="col-sm-6 form-group">
				...
				<div class="col-sm-12 form-group mb-0">
					<a type="button" class="btn btn-basic" href="home.jsp">Cancel</a>
